...
REM
REM Generated by Vivado on Thu Apr 09 15:22:29 +0530 2026
...
echo "xvlog --incr --relax -prj tb_fft64_vlog.prj"
call xvlog  --incr --relax -prj tb_fft64_vlog.prj -log xvlog.log
